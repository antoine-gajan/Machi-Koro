...
BateauPeche::BateauPeche(string &path_image) : Batiment("Petit bateau de pêche",2
                                                        ,"Si vous avez le port, recevez 3 pièces",path_image,Bleu
                                                        ,list<unsigned int>{8},"Bateau"){};
